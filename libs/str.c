...
Token Str_Str_Handler_Ass(ASM* ir,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);

    ASM_InfoHandler(ir,"ass str %s %s",a->str,b->str);
...
Token Str_Str_Handler_Add2(ASM* ir,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);

    ASM_InfoHandler(ir,"add str %s %s",a->str,b->str);

    CStr n1 = ASM_Impl_Str(ir,a);
    CStr n2 = ASM_Impl_Str(ir,b);
...
Token Str_Str_Handler_Add3(ASM* ir,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    Token* c = (Token*)Vector_Get(args,2);

    ASM_InfoHandler(ir,"add str %s %s %s",a->str,b->str,c->str);
...
Token Str_Str_Handler_Equ(ASM* ir,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
...
Token Str_Handler_Cast(ASM* ir,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
...
Token Str_Handler_Destroy(ASM* ir,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    ...
    TypeMap_PushContained(&ir->types,funcs,
        Type_New("str",sizeof(CStr),OperatorInterationMap_Make((OperatorInterater[]){
            ...
            OperatorInterater_Make((CStr[]){ "str",NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_ASM_ASS,   (Token(*)(void*,Token*,Vector*))Str_Str_Handler_Ass),
                OperatorDefiner_New(TOKEN_ASM_ADD,   (Token(*)(void*,Token*,Vector*))Str_Str_Handler_Add2),
                OperatorDefiner_New(TOKEN_ASM_EQU,   (Token(*)(void*,Token*,Vector*))Str_Str_Handler_Equ),
                OPERATORDEFINER_END
            })),
            OperatorInterater_Make((CStr[]){ "str","str",NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_ASM_ADD,   (Token(*)(void*,Token*,Vector*))Str_Str_Handler_Add3),
                OPERATORDEFINER_END
            })),
