    ...
    TypeMap_PushContained(&s->types,funcs,
        Type_New("float",8,OperatorInterationMap_Make((OperatorInterater[]){
            OperatorInterater_Make((CStr[]){ NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_IR_NEG,   (Token(*)(void*,Token*,Vector*))Float_Float_Handler_Neg),
            ...
            OperatorInterater_Make((CStr[]){ "float",NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                ...
                OperatorDefiner_New(TOKEN_IR_ADD,   (Token(*)(void*,Token*,Vector*))Float_Float_Handler_Add),
                OperatorDefiner_New(TOKEN_IR_SUB,   (Token(*)(void*,Token*,Vector*))Float_Float_Handler_Sub),
                OperatorDefiner_New(TOKEN_IR_MUL,   (Token(*)(void*,Token*,Vector*))Float_Float_Handler_Mul),
                OperatorDefiner_New(TOKEN_IR_DIV,   (Token(*)(void*,Token*,Vector*))Float_Float_Handler_Div),
