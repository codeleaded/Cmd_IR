    ...
    TypeMap_PushContained(&s->types,funcs,
        Type_New("float",8,OperatorInterationMap_Make((OperatorInterater[]){
            OperatorInterater_Make((CStr[]){ NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_IR_NEG,Float_Float_Handler_Neg),
            ...
            OperatorInterater_Make((CStr[]){ "float",NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_IR_ASS,Float_Float_Handler_Ass),
                OperatorDefiner_New(TOKEN_IR_ADD,Float_Float_Handler_Add),
                OperatorDefiner_New(TOKEN_IR_SUB,Float_Float_Handler_Sub),
                OperatorDefiner_New(TOKEN_IR_MUL,Float_Float_Handler_Mul),
                OperatorDefiner_New(TOKEN_IR_DIV,Float_Float_Handler_Div),
                OperatorDefiner_New(TOKEN_IR_EQU,Float_Float_Handler_Equ),
                OperatorDefiner_New(TOKEN_IR_LES,Float_Float_Handler_Les),
                OperatorDefiner_New(TOKEN_IR_GRT,Float_Float_Handler_Grt),
                OperatorDefiner_New(TOKEN_IR_LEQ,Float_Float_Handler_Leq),
                OperatorDefiner_New(TOKEN_IR_GRQ,Float_Float_Handler_Grq),
                OPERATORDEFINER_END
            })),
